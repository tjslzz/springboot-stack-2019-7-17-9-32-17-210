...
public class CriminalRepositoryTest {
    ...
    public void should_return_success_given_correct_criminal(){
        Criminal criminal = new Criminal("Jerry Kill Felicity",new Date().getTime(),null,null);
    ...
    public void should_return_true_given_id_of_criminal(){
        Criminal criminal = new Criminal("Jerry Kill Felicity",Long.valueOf("20190717195312"),null,null);
        criminalRepository.save(criminal);
    ...
    public void should_return_asc_list_given_id_of_criminal(){
        Criminal criminal1 = new Criminal("Jerry Kill Felicity",Long.valueOf("20190717195312"),null,null);
        Criminal criminal2 = new Criminal("Jerry Kill Laura",Long.valueOf("20190717195702"),null,null);
    ...
    public void should_return_true_list_given_name_of_criminal(){
        Criminal criminal1 = new Criminal("Jerry Kill Felicity",Long.valueOf("20190717195312"),null,null);
        Criminal criminal2 = new Criminal("Jerry Kill Felicity",Long.valueOf("20190717195702"),null,null);
        criminalRepository.save(criminal1);
        criminalRepository.save(criminal2);
